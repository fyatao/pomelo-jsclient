...
(function (exports,ByteArray, global) {
  ...
  var root = window;
	...
	var sendMessage = function(reqId, route, msg) {
		var packet = Protocol.encode(PKG_DATA,Protocol.body.encode(reqId,0, Protocol.strencode(route), Protocol.strencode(JSON.stringify(msg))));
		send(packet);
	};
	...
	var handshake = function(data){
		...
		var data = JSON.parse(Protocol.strdecode(data));
	...
	var ondata = function(data){
		...
		processMessageBatch(pomelo,JSON.parse(msg));	
	}
